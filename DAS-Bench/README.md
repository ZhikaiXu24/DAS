...
> Benchmark and evaluation component of the [DAS project](../README.md).

This directory releases the data specification and evaluation protocol for DAS-Bench, a benchmark of automatically generated academic surveys.
...
- the public metadata schema and release notes;
...
DAS-Bench is covered by the repository-level [Apache License 2.0](../LICENSE). Use the DAS citation provided in the [project README](../README.md).
